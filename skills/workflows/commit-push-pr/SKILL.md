---
name: commit-push-pr
description: Streamlined workflow to commit changes, push to remote, and create a pull request
version: 2.1.0
model: haiku
allowed-tools: Bash
...
After creating commit, capture and include output verification:
```bash
...
This ensures quality checks pass before pushing.
